...
Scaffold a new [Honosvelte](https://github.com/kabarpos/honosvelte) project —
...
3. Strips dev-only files (`create-honosvelte/`, screenshots, `.env`, etc.).
