...
[![CI](https://github.com/kabarpos/honosvelte/actions/workflows/ci.yml/badge.svg)](https://github.com/kabarpos/honosvelte/actions/workflows/ci.yml)
...
**Honosvelte** — Hono + Svelte; the name is the stack. Every
...
bunx create-honosvelte my-app
cd my-app
bun run dev          # http://localhost:4000

# Or pick a template directly:
bunx create-honosvelte my-app --template svelte-tailwind
```
...
The `default` template (`main` branch) uses React 19 with vanilla CSS — no
...
- Prefer Svelte or Tailwind? `bunx create-honosvelte my-app --template svelte-tailwind`
